...
const HeroSection = () => {
  return (
    <section className="relative min-h-[92vh] sm:min-h-screen flex items-center pt-24 sm:pt-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12 w-full">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div>
            ...
            <motion.h1
              ...
              className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[3.75rem] font-bold leading-[1.1] tracking-tight text-primary text-balance"
            >
            ...
            {/* Stats strip - hidden on mobile, shown on sm+ */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.6, duration: 0.6 }}
              className="mt-12 hidden sm:flex items-center gap-8 sm:gap-12"
            >
              {stats.map((s, i) => (
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-primary/15">
              <img
                src={heroBg}
                alt="UK tutor helping a school pupil with homework"
            ...
            <motion.div
              ...
              className="absolute -bottom-5 -left-3 sm:-left-5 bg-background rounded-2xl shadow-xl shadow-primary/10 p-4 sm:p-5 border border-border/50"
            >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.6, duration: 0.6 }}
          className="mt-10 flex sm:hidden items-center justify-between"
        >
          {stats.map((s, i) => (
