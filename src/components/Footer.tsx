...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://web.facebook.com/bpanaceaeduconsult?rdid=8FSk6MjmE12JurYi&share_url=https%3A%2F%2Fweb.facebook.com%2Fshare%2F1E7qgibJTE%2F%3F_rdc%3D1%26_rdr#",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/panaceaedu101?igsh=MTI3NTdxNDVpZ3FydA%3D%3D&utm_source=qr",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/50">
            ...
            <li>
              <a href="tel:+447774587556" className="hover:text-primary-foreground/80 transition-colors">
                +44 7774 587556
              </a>
            </li>
