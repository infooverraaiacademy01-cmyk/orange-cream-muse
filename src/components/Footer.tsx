    ...
    <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12">
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12">
        <div className="sm:col-span-2 lg:col-span-1">
          <img src={logo} alt="B-Panacea Education" className="h-16 sm:h-20 w-auto object-contain mb-5 brightness-200" />
        ...
        <div>
          ...
          <div className="flex gap-3">
            {["Facebook", "Instagram", "LinkedIn"].map((s) => (
              <a key={s} href="#" className="w-10 h-10 rounded-full bg-primary-foreground/8 flex items-center justify-center text-xs font-bold text-primary-foreground/50 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                {s[0]}
              </a>
            ))}
          </div>
